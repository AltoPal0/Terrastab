...
const pages = [
  ...
  { url: '/prevention-entretien', priority: '0.9', changefreq: 'monthly', lastmod: new Date().toISOString().split('T')[0] },
  { url: '/solution-stabilisation-sol-argileux', priority: '0.8', changefreq: 'monthly', lastmod: new Date().toISOString().split('T')[0] },
  { url: '/micropieux', priority: '0.8', changefreq: 'monthly', lastmod: new Date().toISOString().split('T')[0] },
  ...
  { url: '/dessous-des-cartes', priority: '0.8', changefreq: 'monthly', lastmod: new Date().toISOString().split('T')[0] },
  { url: '/partenariats-innovation', priority: '0.8', changefreq: 'monthly', lastmod: new Date().toISOString().split('T')[0] },
